...
namespace OKRPerformanceManagement.Data.Migrations
{
    ...
    [Migration("20251112071805_AddScheduledDiscussionDate")]
    partial class AddScheduledDiscussionDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OKRPerformanceManagement.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OKRPerformanceManagement.Models.PerformanceReview", b =>
                {
                    ...
                    b.Property<DateTime?>("ScheduledDiscussionDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OKRPerformanceManagement.Models.UserSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OKRPerformanceManagement.Models.Notification", b =>
                {
                    b.HasOne("OKRPerformanceManagement.Models.ApplicationUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("OKRPerformanceManagement.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
